...
export class GettingStartedComponent implements OnDestroy {
  private readonly docs =
    "https://raw.githubusercontent.com/damingerdai/angular-toaster/refs/heads/develop/packages/angular-toaster/README.md";
  private readonly chinaDocs =
    "https://gh-proxy.com/raw.githubusercontent.com/damingerdai/angular-toaster/refs/heads/develop/packages/angular-toaster/README.md";
  ...
  fetchData() {
    ...
    this.sub = race(...reqs)
      .pipe(
        switchMap((data) =>
          defer(() => this.marked.parse(data, { async: true }))
        ),
